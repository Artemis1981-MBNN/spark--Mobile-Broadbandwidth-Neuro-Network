...
| File | Purpose |
|------|---------|
| `config/neural-network.conf.template` | Template for neural network and mobile broadband settings |
| `config/artemis-integration.properties.template` | Template for Artemis1981 repository integration |
